...
benchList.append(Benchmark("Trap", CollisionChecker(trapField, limits = [[0.0,22.0],[0.0,22.0]]), [[10,10]], [[10,5]], description, 2))
...
benchList.append(Benchmark("Bottleneck", CollisionChecker(bottleNeckField), [[4,15]], [[18,3]], description, 2))
...
benchList.append(Benchmark("Fat bottleneck", CollisionChecker(fatBottleNeckField), [[4,18]], [[18,3]], description, 2))
...
benchList.append(Benchmark("Flower Field", CollisionChecker(flowerField), [[3,11]], [[18, 3]], description, 2))
...
benchList.append(Benchmark("Pac-Man", CollisionChecker(pacmanScene), [[1.0,10.3]], [[12.5,1]], description, 2))
...
#benchList.append(Benchmark("Star Obstacle", CollisionChecker(scene1, limits = [[0.0,22.0],[0.0,22.0]]), [[7,6]], [[7,15]], description, 2))
...
benchList.append(Benchmark("dots", CollisionChecker(dots), [[0,0]], [[20,20]], description, 2))
...
game["box"] = Polygon([(1, 0), (1, 20), (20, 20), (20,0), (21,0), (21,21), (0,21), (0,0)]).buffer(.5)
...
benchList.append(Benchmark("Game", CollisionChecker(game, limits = [[0.0,22.0],[0.0,22.0]]), [[10,0]], [[18,18]], description, 2))
